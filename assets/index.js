document.addEventListener('DOMContentLoaded', () => {
    ...
    const start = new Date('2022-12-18 16:00:00Z').getTime();
    ...
    function time() {
        ...
        days.innerText = `${totalDay > 10?  + totalDay : totalDay}`;
        hours.innerText = `${totalHour > 10 ?+ totalHour : totalHour}`;
        minutes.innerText = `${totalMin > 10 ? + totalMin : totalMin}`;
        seconds.innerText = `${totalSec > 10 ?  + totalSec : totalSec}`;
